...
function ContactMe() {
  ...
  const onSubmit: SubmitHandler<Inputs> = (data) => {
    window.location.href = `mailto:papaashik@gmail.com?subject=${data.subject}&body=Hi, my name is ${data.name}. ${data.message}`;
  };
      ...
      <div className="flex flex-col space-y-10">
        ...
        <div className="space-y-10">
          ...
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-2xl">Email address.com</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
