          ...
          >
            ...
            <div className="space-y-10 px-0 md:px-10 max-w-6xl">
              ...
              <p className="text-lg text-center md:text-left">
                ...
                Pariatur veritatis consequatur illum nisi tempore ex assumenda
                veniam labore deleniti ut. Ut fuga iusto ratione quo eaque.
                Debitis non quaerat nostrum saepe placeat laborum ipsa ullam
                eaque, rem blanditiis? Beatae adipisci fugiat tempore quisquam
                nihil eius repellendus nostrum culpa. Tenetur, modi.
              </p>
            </div>
          </motion.div>
        ))}
